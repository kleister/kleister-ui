...
import (
	...
	"github.com/kleister/kleister-ui/pkg/handler"
	"github.com/kleister/kleister-ui/pkg/middleware/header"
	"github.com/kleister/kleister-ui/pkg/middleware/prometheus"
...
func serverFlags(cfg *config.Config) []cli.Flag {
	return []cli.Flag{
		...
		&cli.BoolFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_SERVER_PPROF"},
