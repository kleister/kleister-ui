...
import (
	...
	"github.com/kleister/kleister-ui/pkg/metrics"
	"github.com/kleister/kleister-ui/pkg/router"
...
func ServerFlags(cfg *config.Config) []cli.Flag {
	return []cli.Flag{
		&cli.BoolFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_DEBUG_PPROF"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_METRICS_ADDR"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_METRICS_TOKEN"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_SERVER_ADDR"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_SERVER_HOST"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_SERVER_ROOT"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_SERVER_CERT"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_SERVER_KEY"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_STATIC_PATH"},
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{"KLEISTER_UI_API_ENDPOINT"},
