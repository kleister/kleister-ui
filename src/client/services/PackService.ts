...
export class PackService {
   ...
   * @throws ApiError
   */
  public createPack(requestBody: pack): CancelablePromise<pack | notification> {
    return this.httpRequest.request({
      method: "POST",
      url: "/packs",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public showPack(packId: string): CancelablePromise<pack | notification> {
    return this.httpRequest.request({
      method: "GET",
      url: "/packs/{pack_id}",
      path: {
   ...
   * @throws ApiError
   */
  public deletePack(packId: string): CancelablePromise<notification> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/packs/{pack_id}",
      path: {
