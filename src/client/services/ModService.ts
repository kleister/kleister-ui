...
export class ModService {
   ...
   * @throws ApiError
   */
  public createMod(requestBody: mod): CancelablePromise<mod | notification> {
    return this.httpRequest.request({
      method: "POST",
      url: "/mods",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public showMod(modId: string): CancelablePromise<mod | notification> {
    return this.httpRequest.request({
      method: "GET",
      url: "/mods/{mod_id}",
      path: {
   ...
   * @throws ApiError
   */
  public deleteMod(modId: string): CancelablePromise<notification> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/mods/{mod_id}",
      path: {
